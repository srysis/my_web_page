...
document.querySelector("div.link_to_project.one").addEventListener('click', function() {
	window.location.href = "characters/characters.html";
});

document.querySelector("div.link_to_project.two").addEventListener('click', function() {
